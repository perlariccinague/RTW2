...
<script type="text/javascript">
    ...
    window.addEventListener("load", function () {
        window.cookieconsent.initialise({
            ...
            "type": "opt-in",
            "content": {
                "message": "This website uses cookies to provide the best possible functionality. If you continue the visit, you agree.",
                "allow": "Allow",
                "deny": "Deny",
                "link": "Learn more",
                "href": "https://www.roth-werkzeugbau.de/private-policy",
